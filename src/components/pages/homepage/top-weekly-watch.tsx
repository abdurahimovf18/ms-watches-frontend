			...
			<div className="aspect-[4/3] relative container">
				...
				<div className="absolute left-0 top-0 w-full h-full flex justify-start items-center p-3">
					<div className="flex flex-col">
						<h2 className="text-white text-3xl underline decoration-1 decoration-blue-800 sm:w-[300px] md:w-[350px]
							lg:w-[500px]">
							<span>{data.name}</span>
						</h2>
						<Link
							href={"/"}
							className="link-btn bg-white text-black w-max py-2 px-3 flex justify-center items-center mt-3"
						>
